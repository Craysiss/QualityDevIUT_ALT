...
namespace QD
{
    ...
    // Classe représentant un livre, qui hérite de la classe Media
    ...
    // Classe représentant un DVD, qui hérite de la classe Media
    ...
    // Classe représentant un CD, qui hérite de la classe Media
    ...
    public class Library
    {
        ...
        public void EmprunterMedia(Media media, string utilisateur)
        {
            ...
            // Réalisez l'emprunt du média ici et mettez à jour les informations
            // ...
